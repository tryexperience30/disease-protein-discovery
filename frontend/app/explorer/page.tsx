  ...
  return (
    <div className="space-y-8">
      <header className="stack-copy max-w-3xl">
        <p className="eyebrow">Network patterns</p>
        <h1 className="page-title">Compare Graphlets</h1>
        <p className="lede">
          Graphlets are small building blocks of a network. This page compares disease-level
          73-orbit significance profiles from the existing SNAP dataset. Per-protein 73-orbit ORCA
          signatures are not available in this project.
        </p>
      </header>
      <GraphletMotifs />
      ...
      <section className="space-y-4">
        <h2 className="section-title">
          Side-by-side 73-orbit profiles <ConceptExplainer conceptId="orbit" />
        </h2>
